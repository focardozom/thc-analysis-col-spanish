...
power_data |> 
    ...
    theme(
          ...
          face = "bold", size = 12))
#ggsave("thc_time_series.png", width = 6, height = 4, dpi = 300)
```
...
ggsave("mayor_4_thc_cbd_distribution.png", width = 3, height = 3, dpi = 300)
...
ggsave("thc_distribution.png", width = 3, height = 3, dpi = 600)
...
3. Allows users to input their sample's THC percentage
4. Shows their value as an amber-colored vertical line on the plot
5. Provides text feedback about where their sample falls in the distribution
6. Uses the same color scheme as the rest of your document (#003E42ff and #EEC99Bff)
7. Has a clean, minimal design that matches your document's style

The plot will update automatically when users change the THC value, and it works well for GitHub Pages since it uses Shinylive. Users can:
- Input any THC value between 4% and 30%
- See exactly where their sample falls in the distribution
- Get immediate text feedback about their sample's percentile
- Compare their value to the population statistics

Would you like me to:
1. Adjust the plot's appearance or size?
2. Add more statistical information?
3. Modify the input range or step size?
4. Add additional interactive features?
...
#ggsave("mayor_4_thc_cbd_relationship.png", width = 3, height = 3, dpi = 300)
...
#ggsave("mayor_4_thc_cbd_potency_distribution.png", width = 3, height = 3, dpi = 300)
```
